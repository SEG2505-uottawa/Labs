public class PersonInfo1 {
    ...
    public static String firstName = "Mathieu";
    public static String lastName = "Marchildon";
    public static int studentNo = 7705209;
    public static String description = "I like shitty horror movies";
